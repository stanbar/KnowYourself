...
import com.stasbar.knowyourself.AlarmUtils;
import com.stasbar.knowyourself.AsyncHandler;
...
import com.stasbar.knowyourself.provider.Alarm;
...
public final class AlarmStateManager extends BroadcastReceiver {
    ...
    public static final String ACTION_ALARM_CHANGED = "com.stasbar.lifetimetracker.ALARM_CHANGED";
