...
import static com.stasbar.knowyourself.uidata.UiDataModel.Tab.STOPWATCH;
...
public final class StopwatchService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        final int label = R.string.label_intent;
        switch (action) {
            case ACTION_SHOW_STOPWATCH: {
                ...
                final Intent showStopwatch = new Intent(this, MainActivity.class)
