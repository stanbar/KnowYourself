...
import com.stasbar.knowyourself.DeskClock;
...
import com.stasbar.knowyourself.data.TimerListener;
import com.stasbar.knowyourself.databinding.TimerFragmentBinding;
...
public final class TimerFragment extends Fragment {
    ...
    private static final String EXTRA_TIMER_SETUP = "com.stasbar.lifetimetracker.action.TIMER_SETUP";
    ...
    public static TimerFragment newInstance(ActivityItem activityItem) {
        ...
        if (mCurrentView == mTimersView) {
            ...
            switch (timer.getState()) {
                case RUNNING:
                    ...
                    button.setCompoundDrawables(ContextCompat.getDrawable(getActivity(), R.drawable.ic_pause_white_24dp), null, null, null);
                    button.setText(getString(R.string.start));
                    break;
                case PAUSED:
                case RESET:
                    DataModel.getDataModel().startTimer(timer);
                    button.setCompoundDrawables(ContextCompat.getDrawable(getActivity(), R.drawable.ic_start_white_24dp), null, null, null);
