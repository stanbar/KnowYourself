...
public final class UiDataModel {
    ...
    public enum Tab {
        ...
        ACTIVITIES(ActivitiesFragment.class, R.drawable.ic_tab_timer, R.string.menu_activities),
        FEELINGS(FeelingsFragment.class, R.drawable.ic_tab_timer, R.string.menu_feelings),
